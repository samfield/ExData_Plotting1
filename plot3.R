#The following script implements submission 1/part 3 of Exploratory Data Analysis course in Coursera
...
#save plot
ggsave(filename = paste(getwd(),"plot3.png",sep = "/"), plot = plot3, width =6.4,height = 6.4, units = "in", dpi = 75)
